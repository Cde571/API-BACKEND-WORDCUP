...
# CONFIGURACIÓN
# --------------------------------------------------
API_BASE = os.getenv("SCRAPER_API_BASE") or os.getenv("API_BASE") or "http://localhost:4000/api"
    ...
    for fila in filas:
        ...
        try:
            ...
            payload_jugador = {
                ...
                "teamId": team_id,
                "number": int(num_raw) if str(num_raw).isdigit() else None,
                "photo": foto_url,
            }
...
def main():
    ...
    try:
        ...
        print(f"   Verifica que la API esté activa en: {API_BASE}\n")
        return
